...
- Schema compliance is very important.
...
- Each chapter must contain 5 to 7 blocks
...
- At least one block per chapter MUST include the Focus **naturally**.
...
- Use the Focus **in ways native speakers actually say it**, in realistic situations
